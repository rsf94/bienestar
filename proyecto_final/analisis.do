	...
	* Nos querdamos con población en edad de estudiar?
	...
	local indep consumo_marihuana consumo_cocaina   mujer indice_marginacion ingreso prevencion_escuela 
	probit estudia `indep' if edad_estudiar==1
	estimates store m9 
	
	local indep consumo_marihuana consumo_cocaina consumo_menos_frecuentes   mujer indice_marginacion ingreso prevencion_escuela 
	probit estudia `indep' if edad_estudiar==1
	estimates store m10
